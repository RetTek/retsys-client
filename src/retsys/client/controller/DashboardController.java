...
public static HostServices hostServices;
    ...
    private void initializeNewMenuTree() {
        ...
        String[][] level2 = new String[][]{new String[]{"Project", "project","3","1"}, new String[]{"Product", "product","4","2"}, new String[]{"Client", "client","5","1"},new String[]{"Vendor", "vendor","9","2"},new String[]{"Purchase Order", "purchaseorder","14","2"},new String[]{"Purchase Order Confirm", "purchaseorderconfirm","18","2"},new String[]{"Items", "item5","25","2"}};
