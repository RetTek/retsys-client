...
public class DashboardController extends AnchorPane implements Initializable {
    ...
    private void initializeNewMenuTree() {
        ...
        String[][] level2 = new String[][]{new String[]{"Project", "project","5","1"}, new String[]{"Product", "product","4","2"}, new String[]{"Client", "client","3","1"},new String[]{"Vendor", "vendor","9","2"},new String[]{"Purchase Order", "purchaseorder","14","2"},new String[]{"Items", "item5","25","2"}};
        String[][] level3 = new String[][]{new String[]{"Project Maintainence", "/retsys/client/fxml/Project.fxml","6","5"}, new String[]{"Product Maintenance", "/retsys/client/fxml/Product.fxml","7","4"}, new String[]{"Client Maintenance", "/retsys/client/fxml/Client.fxml","8","3"}, new String[]{"Vendor Maintenance", "/retsys/client/fxml/Vendor.fxml","10","9"}, new String[]{"Purchase Order Maintenance", "/retsys/client/fxml/PurchaseOrder.fxml","15","14"}, new String[]{"Item Maintenance", "/retsys/client/fxml/Item.fxml","26","25"}};
